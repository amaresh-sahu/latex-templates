...
\begin{document}
	...
	\small
	\noindent{\linkdest{email1}{\hspace{10pt}$^\ddag \,$}\href{mailto:amaresh.sahu@berkeley.edu}{amaresh.sahu\textit{@}berkeley.edu} \\
		\linkdest{email2}{\hspace{10pt}$^\S \,$}address.two\textit{@}affiliation.edu \\
		\linkdest{email3}{\hspace{10pt}$^\dag \,$}address.three\textit{@}affiliation.edu
	}
